...
OUTPUT_BASE_DIR="/mnt/media/SSD-PUTA/output_SAM2-CLIP/TOTAL_CLIP_ViT-B32_finetuned_v14"
...
TEXT_PROMPT_NEW="car. sidewalk. person. building. vegetation. bike. bicycle. pole. fence. guard rail. wall. ego vehicle. truck. bus. license plate. polegroup. traffic light. sky."
DEVICE="cuda"
...
for INPUT_IMAGE in "$INPUT_DIR"*.png; do
    ...
    python grounded_sam2_demo_CLIP_20241231v14.py \
        ...
        --text_prompt_new "$TEXT_PROMPT_NEW" \
