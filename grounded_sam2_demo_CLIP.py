...
if __name__ == "__main__":
    ...
    labels = [
        ...
        in zip(new_class_names, confidences)
    ]
    ...
    cv2.imwrite(os.path.join(args.output_dir, "groundingdino_annotated_image_CLIP.jpg"), annotated_frame)
    ...
    cv2.imwrite(os.path.join(args.output_dir, "grounded_sam2_annotated_image_with_mask_CLIP.jpg"), annotated_frame_with_mask)
    ...
    if args.dump_json:
        ...
        with open(os.path.join(args.output_dir, "grounded_sam2_results_CLIP.json"), "w") as f:
